...
class GdmService {
  ...
  Future<void> openNewSession(String username, String? password) async {
    ...
    var infoSignal = DBusRemoteObjectSignalStream(object: userVerifier,
                                                  interface: 'org.gnome.DisplayManager.UserVerifier',
                                                  name: 'Info');
    var infoQuerySignal = DBusRemoteObjectSignalStream(object: userVerifier,
                                                       interface: 'org.gnome.DisplayManager.UserVerifier',
                                                       name: 'InfoQuery');
    var secretInfoQuerySignal = DBusRemoteObjectSignalStream(object: userVerifier,
                                                             interface: 'org.gnome.DisplayManager.UserVerifier',
                                                             name: 'SecretInfoQuery');
    var problemSignal = DBusRemoteObjectSignalStream(object: userVerifier,
                                                     interface: 'org.gnome.DisplayManager.UserVerifier',
                                                     name: 'Problem');
    var sessionOpenedSignal = DBusRemoteObjectSignalStream(object: greeter,
